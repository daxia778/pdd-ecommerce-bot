<template>
  <div class="mb-3">
    ...
    <div v-if="!isEditing" class="p-3 bg-gray-50 rounded-xl border border-gray-100 group relative hover:border-purple-200 transition-colors cursor-pointer" @click="startEdit">
      ...
      <div class="text-sm font-bold whitespace-pre-wrap break-words" :class="[highlight ? 'text-orange-600' : 'text-gray-800', !currentValue || currentValue === '-' ? 'text-gray-300 italic font-medium' : '']">
        {{ currentValue || '-' }}
      </div>
